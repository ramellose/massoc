"""
This module describes a driver for carrying out analyses on metadata in Neo4j graph databases.
For example, the module can associate metadata to taxon abundances,
or it can agglomerate associations in based on taxonomy.
"""
